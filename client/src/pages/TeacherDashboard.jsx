...
const TeacherDashboard = () => {
    ...
    }, [classroomData.classrooms, userData.user]);
...
<div className="bg-white rounded-2xl shadow-sm overflow-hidden mb-6"
    ...
    {/* Table Headers */}
    <div className="grid grid-cols-4 py-3 px-6 border-b border-gray-200 bg-gray-50">
    ...
    <div className="divide-y divide-gray-200">
        {filteredStudents.length > 0 ? (
            filteredStudents.map(student => (
                <div key={student._id} className="grid grid-cols-4 py-4 px-6 items-center hover:bg-gray-50">
                    <div className="col-span-1">
                        <p className="font-medium truncate">{student.firstName} {student.lastName}</p>
                        <p className="text-sm text-gray-500 truncate">{student.email}</p>
                    </div>
                    <div className="flex flex-wrap gap-1 col-span-1 max-w-full overflow-hidden">
                    ...
                    <div className="text-gray-800 col-span-1 text-center">{student.quizzesTaken}</div>
                    <div className="col-span-1">
